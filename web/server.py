...
def main():
    ...
    with socketserver.TCPServer(("", PORT), MyHTTPRequestHandler) as httpd:
        ...
        print("=" * 60)
        print("🇨🇳 Chinese OCR Tips:")
        print("   • Use high-resolution images (300+ DPI)")
        print("   • Ensure clear, high-contrast text")
        print("   • Avoid handwritten text for best results")
        print("   • First Chinese load takes longer (downloading 15MB language data)")
        print("=" * 60)
